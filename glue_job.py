...
Aggregate_node1719267560128 = sparkAggregate(glueContext, parentFrame = AmazonS3_node1719265558667, groups = ["date", "setor_acao", "cod_acao"], aggs = [["qtd_acao", "sum"]], transformation_ctx = "Aggregate_node1719267560128")

# Script generated for node Rename Field
RenameField_node1719270814013 = RenameField.apply(frame=Aggregate_node1719267560128, old_name="`sum(qtd_acao)`", new_name="qtd_acao_por_setor_e_data", transformation_ctx="RenameField_node1719270814013")
...
AmazonS3_node1719274399403.setCatalogInfo(catalogDatabase="tech-challenge",catalogTableName="pregao_com_data_e_setor")
